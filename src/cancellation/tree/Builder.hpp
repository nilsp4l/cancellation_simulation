...
namespace cancellation::tree {
    ...
    struct Builder {
        static constexpr std::unique_ptr<Node> build(query::Context<cancel_type, cleanup_type> *context, benchmark::CancelCheckpointRegistry* cancel_checkpoint_registry) {
